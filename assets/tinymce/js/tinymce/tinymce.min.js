...
(function(e, t) {
    ...
    var s = {},
        ...
        Wt = "tinymce/ui/MenuBar",
        zt = "tinymce/ui/MenuButton",
        Vt = "tinymce/ui/ListBox",
        Ut = "tinymce/ui/MenuItem",
        qt = "tinymce/ui/Menu",
        $t = "tinymce/ui/Radio",
        jt = "tinymce/ui/RadioGroup",
        Kt = "tinymce/ui/ResizeHandle",
        Gt = "tinymce/ui/Spacer",
    ...
    r(l, [], function() {
            ...
            c = a + (+new Date).toString(32), d = "onmouseenter" in document.documentElement, u = "onfocusin" in document.documentElement, f = {
                ...
                if (n && 3 !== n.nodeType && 8 !== n.nodeType) {
                    for (n[c] ? g = n[c] : (g = l++, n[c] = g, s[g] = {}), h = h || n, a = a.split(" "), y = a.length; y--;) b = a[y], x = m, C = w = !1, "DOMContentLoaded" === b && (b = "ready"), o.domLoaded && "ready" === b && "complete" == n.readyState ? p.call(h, r({
                        ...
                        var n, i;
                        if (n = e.currentTarget, i = e.relatedTarget, i && n.contains) i = n.contains(i);
                        else
                ...
                if (i = e[c]) {
                    if (f = s[i], t) {
                        for (t = t.split(" "), l = t.length; l--;)
                            if (d = t[l], a = f[d]) {
                                if (r)
                                    for (u = a.length; u--;) a[u].func === r && a.splice(u, 1);
        ...
        function g(e, t, n, r, o, a) {
            return r && !r[F] && (r = g(r)), o && !o[F] && (o = g(o, a)), i(function(i, a, s, l) {
                var c, u, d, f = [],
                    ...
                    y = n ? o || (i ? e : h || r) ? [] : a : v;
                if (n && n(v, y, s, l), r)
                    for (c = m(y, p), r(c, [], s, l), u = c.length; u--;)(d = c[u]) && (y[p[u]] = !(v[p[u]] = d));
                if (i) {
                    if (o || e) {
                        if (o) {
        ...
        function v(e) {
            for (var t, n, r, i = e.length, o = N.relative[e[0].type], a = o || N.relative[" "], s = o ? 1 : 0, l = p(function(e) {
                ...
                if (n = N.relative[e[s].type]) u = [p(h(u), n)];
                else {
            ...
            var n = 0,
                ...
                s = function(i, s, l, c, u) {
                    var d, f, p, h = [],
                        ...
                        b = null != u,
                        C = T,
                        x = i || o && N.find.TAG("*", u && s.parentNode || s),
        ...
        function x() {}
        var w, _, N, E, k, S, T, R, A, B, L, H, M, D, P, O, I, F = "sizzle" + -new Date,
            W = window.document,
            z = {},
            V = 0,
            U = 0,
                ...
                CHILD: function(e, t, n, r, i) {
                    ...
                    return 1 === r && 0 === i ? function(e) {
                        ...
                        if (g) {
                            ...
                            } else if (y && (c = (t[F] || (t[F] = {}))[e]) && c[0] === V) f = c[1];
                            else
                                for (;
                                    (d = ++p && d && d[m] || (f = p = 0) || h.pop()) && ((s ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++f || (y && ((d[F] || (d[F] = {}))[e] = [V, f]), d !== t)););
        ...
        function a(e, t, n) {
            ...
            if ("string" == typeof t) t = o(t);
                ...
                for (r = 0; t.length > r; r++) a(e, t[r], n);
                return e
            }
        ...
        return c.fn = c.prototype = {
            ...
            css: function(e, n) {
                ...
                if ("object" == typeof e) p(e, function(e, t) {
                    ...
                    "number" != typeof n || x[e] || (n += "px"), i.each(function() {
                        var r = this.style;
                        "opacity" === e && this.runtimeStyle && this.runtimeStyle.opacity === t && (r.filter = "" === n ? "" : "alpha(opacity=" + 100 * n + ")");
                        try {
                            r[e] = n
                        } catch (i) {}
                    })
            ...
            c.fn[e] = function(n) {
                var r = this,
                    i;
                if (r.length > 1) throw Error("DomQuery only supports traverse functions on a single node.");
        ...
        return c.prototype = {
            ...
            createHTML: function(e, n, r) {
                var i = "",
                    o;
                i += "<" + e;
                for (o in n) n.hasOwnProperty(o) && null !== n[o] && (i += " " + o + '="' + this.encode(n[o]) + '"');
                return r !== t ? i + ">" + r + "</" + e + ">" : i + " />"
            },
        ...
        return function(n, i) {
            ...
            n = n || {}, o.schema = i = i || new e, n.fix_self_closing !== !1 && (n.fix_self_closing = !0), r("comment cdata text start end pi doctype".split(" "), function(e) {
                ...
                var a = this,
                    s, l = 0,
                    c, u, d = [],
                    f, p, h, m, g, v, y, b, C, x, w, _, N, E, k, S, T, R, A, B, L, H, M, D, P, O = 0,
                    I = t.decode,
                    F;
                        ...
                        if (c = c.toLowerCase(), ":" === c.charAt(0) && (c = c.substr(1)), C = c in y, F && L[c] && d.length > 0 && d[d.length - 1].name === c && r(c), !x || (w = i.getElementRule(c))) {
                            if (_ = !0, x && (k = w.attributes, S = w.attributePatterns), (E = s[8]) ? (g = -1 !== E.indexOf("data-mce-type"), g && v && (_ = !1), f = [], f.map = {}, E.replace(M, o)) : (f = [], f.map = {}), x && !g) {
                                if (T = w.attributesRequired, R = w.attributesDefault, A = w.attributesForced, B = w.removeEmptyAttrs, B && !f.length && (_ = !1), A)
                                    for (p = A.length; p--;) N = A[p], m = N.name, P = N.value, "{$uid}" === P && (P = "mce_" + O++), f.map[m] = P, f.push({
                                        name: m,
                                        value: P
                                    });
                                if (R)
                                    for (p = R.length; p--;) N = R[p], m = N.name, m in f.map || (P = N.value, "{$uid}" === P && (P = "mce_" + O++), f.map[m] = P, f.push({
                                        name: m,
                                        value: P
                                    }));
                                if (T) {
        ...
        return function(i, c) {
            function u(t) {
                ...
                for (m = o("tr,td,th,tbody,thead,tfoot,table"), h = c.getNonEmptyElements(), g = c.getTextBlockElements(), n = 0; t.length > n; n++)
            ...
            i = i || {}, i.validate = "validate" in i ? i.validate : !0, i.root_name = i.root_name || "body", d.schema = c = c || new n, d.filterNode = function(e) {
                ...
                a(s(e), function(e) {
                    ...
                    for (r = 0; p.length > r; r++)
                        if (p[r].name === e) return p[r].callbacks.push(n), t;
                    p.push({
                        name: e,
                        callbacks: [n]
                    })
                ...
                var y, b, C, x, w, _, N, E, k, S, T, R, A, B = [],
                    L, H, M, D, P, O, I, F;
                if (a = a || {}, h = {}, m = {}, R = l(o("script,style,head,html,body,title,meta,param"), c.getBlockElements()), I = c.getNonEmptyElements(), O = c.children, T = i.validate, F = "forced_root_block" in a ? a.forced_root_block : i.forced_root_block, P = c.getWhiteSpaceElements(), A = /^[ \t\r\n]+/, H = /[ \t\r\n]+$/, M = /[ \t\r\n]+/g, D = /^[ \t\r\n]+$/, y = new r({
                        ...
                        start: function(e, t, n) {
                            ...
                            if (i = T ? c.getElementRule(n) : {}) {
                                if (R[n] && !L) {
                                    if (r = C.firstChild, r && 3 === r.type)
                                        if (o = r.value.replace(A, ""), o.length > 0) r.value = o, r = r.next;
                                        else
                                            for (a = r.next, r.remove(), r = a; r && 3 === r.type;) o = r.value, a = r.next, (0 === o.length || D.test(o)) && (r.remove(), r = a), r = a;
                                    if (r = C.lastChild, r && 3 === r.type)
                                        if (o = r.value.replace(H, ""), o.length > 0) r.value = o, r = r.prev;
                                        else
                                            for (a = r.prev, r.remove(), r = a; r && 3 === r.type;) o = r.value, a = r.prev, (0 === o.length || D.test(o)) && (r.remove(), r = a), r = a
                                }
                                if (L && P[n] && (L = !1), (i.removeEmpty || i.paddEmpty) && C.isEmpty(I))
                                    if (i.paddEmpty) C.empty().append(new e("#text", "3")).value = "\u00a0";
                    ...
                    for (w = 0, _ = p.length; _ > w; w++)
                        if (k = p[w], k.name in m) {
                ...
                var n, r = t.length,
                    i, o = l({}, c.getBlockElements()),
                    a = c.getNonEmptyElements(),
                    s, u, d, f, p, h;
                for (o.body = 1, n = 0; r > n; n++)
                    if (i = t[n], s = i.parent, o[i.parent.name] && i === s.lastChild) {
                        for (d = i.prev; d;) {
        ...
        return function(i, o) {
            ...
            function h(e) {
                ...
                for (r in _)
                    if (i = _[r], a = t.offsetWidth * i[0], s = t.offsetHeight * i[1], 8 > Math.abs(a - l) && 8 > Math.abs(s - u)) {
                        N = i;
                        break
                    }
            ...
            var b = o.dom,
                C = n.each,
                x, w, _, N, E, k, S, T, R, A, B, L, H, M, D = o.getDoc(),
                P = document,
                O = r.ie;
            _ = {
                n: [.5, 0, 0, -1],
        ...
        return a.prototype = {
            ...
            getSelectedBlocks: function(t, n) {
                ...
                if (t = i.getParent(t || r.getStart(), i.isBlock), n = i.getParent(n || r.getEnd(), i.isBlock), t && a.push(t), t && n && t != n) {
                    o = t;
                    for (var s = new e(t, i.getRoot());
                        (o = s.next()) && o != n;) i.isBlock(o) && a.push(o)
                }
            ...
            normalize: function() {
                function n(n) {
                    function s(t, n) {
                        for (var r = new e(t, p.getParent(t.parentNode, p.isBlock) || h); t = r[n ? "prev" : "next"]();)
            ...
            selectorChanged: function(e, n) {
                ...
                return r.selectorChangedData || (r.selectorChangedData = {}, i = {}, r.editor.on("NodeChange", function(e) {
                    var n = e.element,
                        o = r.dom,
                        a = o.getParents(n, null, o.getRoot()),
                        l = {};
        ...
        return function(i) {
            ...
            function h(n, r, a) {
                ...
                function c() {
                    function t(t, n) {
                        var r = new e(n);
                        for (a = r.current(); a; a = r.prev())
                            if (a.childNodes.length > 1 || a == t || "BR" == a.tagName) return a
                    }
                ...
                var m = u(n),
                    g = m[0],
                    y, b, C = !a && F.isCollapsed();
                if (g)
                    if (a) a.nodeType ? (b = I.createRng(), b.setStartBefore(a), b.setEndAfter(a), f(T(b, m), null, !0)) : f(a, null, !0);
            ...
            function m(e, n, r) {
                function o(e) {
                    var t, r, i, a, s;
                    if (1 === e.nodeType && J(e) && (a = C, C = "true" === J(e), s = !0), t = tt(e.childNodes), C && !s)
                        for (r = 0, i = h.length; i > r && !R(h[r], n, e, e); r++);
                    if (m.deep && t.length) {
                ...
                function l(e, t, r, i) {
                    ...
                    if (e) {
                        for (u = e.parentNode, o = t.parentNode; o && o != u; o = o.parentNode) {
                            for (a = I.clone(o, K), c = 0; h.length > c; c++)
                                if (R(h[c], n, a, a)) {
                                    a = 0;
                                    break
                                }
            ...
            function v(e, t, n, r) {
                    ...
                    if (s)
                        if (s.length === X) {
                            ...
                            for (l = 0; s.length > l; l++)
                                if ("attributes" === i ? I.getAttrib(e, s[l]) : N(e, s[l])) return t;
                    return t
                }
                var o = u(t),
                    a, s, l;
                if (o && e)
                    for (s = 0; o.length > s; s++)
                        if (a = o[s], w(e, a) && i(e, a, "attributes") && i(e, a, "styles")) {
                            if (l = a.classes)
            ...
            function C(e) {
                var t = u(e),
                    n, r, i, o, s;
                if (t)
                    for (n = F.getStart(), r = a(n), o = t.length - 1; o >= 0; o--) {
                        if (s = t[o].selector, !s) return G;
                        for (i = r.length - 1; i >= 0; i--)
                            if (I.is(r[i], s)) return G
                    }
                return K
            }
            ...
            function T(n, r, s) {
                ...
                function d(n, r, o) {
                    ...
                    for (l = new e(n, I.getParent(n, V) || i.getBody()); c = l[o ? "prev" : "next"]();)
                        if (3 === c.nodeType) {
                ...
                function f(e, t) {
                    var i, o, s, l;
                    for (3 == e.nodeType && 0 === e.nodeValue.length && e[t] && (e = e[t]), i = a(e), o = 0; i.length > o; o++)
                        for (s = 0; r.length > s; s++)
                            if (l = r[s], !("collapsed" in l && l.collapsed !== n.collapsed) && I.is(i[o], l.selector)) return i[o];
                    return e
                }

                function p(e, t) {
                    var n;
                    if (r[0].wrapper || (n = I.getParent(e, r[0].block)), n || (n = I.getParent(3 == e.nodeType ? e.parentNode : e, o)), n && r[0].wrapper && (n = a(n, "ul,ol").reverse()[0] || n), !n)
                        for (n = e; n[t] && !V(n[t]) && (n = n[t], !_(n, "br")););
                    return n || e
                }
                var h, m, g, v = n.startContainer,
                    y = n.startOffset,
                    b = n.endContainer,
                    C = n.endOffset;
            ...
            function R(e, n, r, i) {
                ...
                if ("all" != e.remove)
                    for (et(e.styles, function(e, t) {
                        ...
                        }), a = I.getAttribs(r), o = 0; a.length > o; o++)
                        if (0 !== a[o].nodeName.indexOf("_")) return K;
                return "none" != e.remove ? (A(r, e), G) : t
            }
            ...
            function D(t, n, r) {
                ...
                function f() {
                    ...
                    if (c)
                        if (s) a = F.getBookmark(), e.collapse(!0), e = T(e, u(n), !0), e = W.split(e), m(n, r, e), F.moveToBookmark(a);
                        else {
            ...
            function P(n) {
                var r = n.startContainer,
                    i = n.startOffset,
                    o, a, s, l, c;
                if (3 == r.nodeType && i >= r.nodeValue.length && (i = q(r), r = r.parentNode, o = !0), 1 == r.nodeType)
                    for (l = r.childNodes, r = l[Math.min(i, l.length - 1)], a = new e(r, I.getParent(r, I.isBlock)), (i > l.length - 1 || o) && a.next(), s = a.current(); s; s = a.next())
                        if (3 == s.nodeType && !k(s)) return c = I.create("a", null, $), s.parentNode.insertBefore(c, s), n.setStart(s, 0), F.setRng(n), I.remove(c), t
            }
            var O = {},
                I = i.dom,
                F = i.selection,
                W = new n(I),
                z = i.schema.isValidChild,
                V = I.isBlock,
                U = i.settings.forced_root_block,
                q = I.nodeIndex,
                $ = "\ufeff",
                j = /^(src|href|style)$/,
                K = !1,
                G = !0,
                Y, X, J = I.getContentEditable,
                Q, Z, et = r.each,
                tt = r.grep,
                nt = r.walk,
                rt = r.extend;
    ...
    }), r(H, [g, p], function(e, n) {
        var r = n.trim,
            i;
        return i = RegExp(["<span[^>]+data-mce-bogus[^>]+>[\u200b\ufeff]+<\\/span>", "<div[^>]+data-mce-bogus[^>]+><\\/div>", '\\s?data-mce-selected="[^"]+"'].join("|"), "gi"),
            function(n) {
                function o() {
        ...
        return function(n) {
            function i(i) {
                ...
                function m(e) {
                    var t = S,
                        n, i, a;
                    if (n = e || "TABLE" == D ? o.create(e || O) : R.cloneNode(!1), a = n, s.keep_styles !== !1)
                        do
                ...
                function b() {
                    for (var t = new e(S, R), n; n = t.next();)
            ...
            o(this, {
                ...
                mceInsertContent: function(t, r, i) {
                    ...
                    if (/^ | $/.test(i) && (i = o(i)), a = n.parser, s = new e({}, n.schema), b = '<span id="mce_marker" data-mce-type="bookmark">&#xFEFF;</span>', f = {
                        ...
                        }, d = a.parse(i, f), v = d.lastChild, "mce_marker" == v.attr("id"))
            ...
            s, l = e.extend({
                init: function(e) {
                    ...
                    function d(e, t) {
                        var n = [],
                            r, i, a;
                        do
                            if (o.exec(""), i = o.exec(e), i && (e = i[3], n.push(i[1]), i[2])) {
                                r = i[3];
                                break
                            }
                        while (i);
                ...
                match: function(e, t) {
                    ...
                    for (t = t || this._selectors, r = 0, i = t.length; i > r; r++) {
                        for (s = t[r], a = s.length, m = e, h = 0, o = a - 1; o >= 0; o--)
                            for (u = s[o]; m;) {
                                for (u.psuedo && (p = m.parent().items(), d = n.inArray(m, p), f = p.length), l = 0, c = u.length; c > l; l++)
                                    if (!u[l](m, d, f)) {
                                        l = c + 1;
                                        break
                                    }
        ...
        return l
    }), r(W, [p, F, I], function(e, n, r) {
        var i, o, a = Array.prototype.push,
            ...
            c = e.extend({
                ...
                on: function(e, n) {
                    ...
                    var i = this,
                        a, s, l, c;
                    if (n)
                        for ("string" == typeof n && (n = r(n)), l = e.toLowerCase().split(" "), c = l.length; c--;) e = l[c], a = i._bindings, a || (a = i._bindings = {}), s = a[e], s || (s = a[e] = []), s.push(n), o[e] && (i._nativeEvents ? i._nativeEvents[e] = !0 : i._nativeEvents = {
                            name: !0
    ...
    }), r(q, [V, W, F, U, p, z], function(e, n, r, i, o, a) {
        var s = {};
        return e.extend({
            layout: "",
                ...
                init: function(e) {
                    function t() {
                        var e, t = u.zIndex || 65535,
                            n;
                        if (l.length)
                            for (e = 0; l.length > e; e++) l[e].modal && (t++, n = l[e]), l[e].getEl().style.zIndex = t, l[e].zIndex = t, t++;
        ...
        return function(n) {
            ...
            function a(e) {
                for (var t, n = e || i(); n = n.parentNode;)
                    if (t = o(n)) return t
            }
            ...
            function d() {
                var e, i;
                for (i = o(n.root.getEl()), r(), e = m.length; e--;)
                    if ("toolbar" == i && m[e].id === g) return m[e].focus(), t;
                m[0].focus()
            }
            var f = n.root,
                p = n.enableUpDown !== !1,
    ...
    }), r(Q, [X, K, z, J, $], function(e, n, r, i, o) {
        var a = e.extend({
            modal: !0,
            Defaults: {
                border: 1,
            ...
            fullscreen: function(e) {
                var t = this,
                    ...
                    a;
                if (e != t._fullscreen)
                    if (r.on(window, "resize", function() {
                            var e;
                            if (t._fullscreen)
    ...
    }), r(tt, [T, B, C, m, g, p], function(e, n, r, i, o, a) {
        return function(s) {
            function l(e, t) {
                try {
    ...
    }), r(it, [v, b, C, k, E, A, L, H, M, D, P, O, y, l, et, x, _, tt, g, p, nt, rt], function(e, n, r, i, o, a, s, l, c, u, d, f, p, h, m, g, v, y, b, C, x, w) {
        function _(e, t) {
        ...
        var c = n.DOM,
            ...
            h, m = {
                ...
                remove: function(e) {
                    ...
                    for (delete r[e.id], n = 0; r.length > n; n++)
                        if (r[n] == e) {
                            r.splice(n, 1);
                            break
                        }
        ...
        return e.extend({
            recalc: function(e) {
                var t, n, r, i, o, a, s, l, c, u, d, f, p, h, m, g, v = [],
                    y, b, C, x, w, _, N, E, k, S, T, R, A, B, L, H, M, D, P, O, I, F, W, z, V = Math.max,
                    U = Math.min;
    ...
    }), r(Dt, [U, V, X, p, st], function(e, n, r, i, o) {
        function a(e) {
            function n(e) {
        ...
        n.translate = function(e) {
            ...
            g = n(), l({
                ...
                var n = [],
                    r = s("Paragraph=p;Address=address;Pre=pre;Header 1=h1;Header 2=h2;Header 3=h3;Header 4=h4;Header 5=h5;Header 6=h6");
                ...
                var n = [],
                    r = s("Andale Mono=andale mono,times;Arial=arial,helvetica,sans-serif;Arial Black=arial black,avant garde;Book Antiqua=book antiqua,palatino;Comic Sans MS=comic sans ms,sans-serif;Courier New=courier new,courier;Georgia=georgia,palatino;Helvetica=helvetica;Impact=impact,chicago;Symbol=symbol;Tahoma=tahoma,arial,helvetica,sans-serif;Terminal=terminal,monaco;Times New Roman=times new roman,times;Trebuchet MS=trebuchet ms,geneva;Verdana=verdana,geneva;Webdings=webdings;Wingdings=wingdings,zapf dingbats");
                return l(r, function(e) {
                    n.push({
                        text: {
                            raw: e[0]
        ...
        var i = e.extend({
            ...
            text: function(e) {
                var t = this,
                    n, r;
                if (t._rendered)
                    for (r = t.getEl("open").childNodes, n = 0; r.length > n; n++) 3 == r[n].nodeType && (r[n].data = t.encode(e));
        ...
        return e.extend({
            ...
            value: function(e) {
                ...
                var r = this,
                    i, o, a, s;
                if (e !== t) {
                    if (r.menu) n(r.menu, e);
                    else
                        for (a = r.settings.menu, s = 0; a.length > s; s++) i = a[s].value == e, i && (o = o || a[s].text), a[s].active = i;
                    r.text(o)
                }
                return r._super(e)
            }
        })
    }), r(Ut, [yt, U], function(e, t) {
        return e.extend({
            Defaults: {
                border: 0,
                role: "menuitem"
    ...
    }), a([l, c, u, d, f, p, h, m, g, v, y, b, C, x, w, _, N, E, k, S, T, R, A, B, L, H, M, D, P, O, I, F, W, z, V, U, q, $, j, K, G, Y, X, J, Q, Z, et, tt, nt, rt, it, ot, at, st, lt, ct, ut, dt, ft, pt, ht, mt, gt, vt, yt, bt, Ct, xt, wt, _t, Nt, Et, kt, St, Tt, Rt, At, Bt, Lt, Ht, Mt, Dt, Pt, Ot, It, Ft, Wt, zt, Vt, Ut, qt, $t, jt, Kt, Gt, Yt, Xt, Jt, Qt, Zt])
})(this);