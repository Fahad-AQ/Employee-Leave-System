					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<?php } ?>			
								<li class="<?php if ($this->uri->segment(2) == "requests"){ echo "active";}?>"><a href="<?php echo base_url('manager/requests');?>"><i class="icon-books text-teal-400"></i> <span>Requests</span></a></li>	
							</ul>
						</div>
					</div>
					<!-- /main navigation -->
