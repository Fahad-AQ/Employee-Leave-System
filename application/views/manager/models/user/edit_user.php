					      ...
					      <div class="form-group">
							...
							<div class="row">
								<div class="col-lg-6">
									...
									<input type="text" id="eu_empFname" name="fName" title="1 till 30 letter father name allowed ex: Shabbir Ahmed" placeholder="Enter Employee Father Name"  class="form-control required_editUser">
								</div>
								<div class="col-lg-6">
								...
								<div class="col-lg-6">
									<div class="form-group">
										<label class="control-label text-bold col-lg-6">Date of Birth:</label>
											<div class="col-lg-14">
											<input type="date" id="eu_dob" name="dob" pattern="(0[1-9]|1[012])[/](0[1-9]|[12][0-9]|3[01])[/](19|20)\d\d" title="Correct dates allowed ex: 09/22/1993"  placeholder="Enter Start Date"  class="dob form-control required_editUser">
											</div>
									</div>
								 </div>
								<div class="col-lg-6">
								...
								<div class="col-lg-12">
									<div class="form-group">
										<label class="control-label text-bold col-lg-6">Address:</label>
											<div class="col-lg-14">
											  <textarea id="eu_address" name="address" rows="3" cols="3"  pattern="([a-zA-Z0-9\s+]{5,500})"   title="1 till 500 letter name allowed ex: Malir Karachi" class="form-control required_editUser" placeholder="Enter Employee Address"></textarea>
											</div>
									</div>
								 </div>	
						    </div>
