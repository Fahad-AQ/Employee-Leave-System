...
<div class="content">
	...
	<div class="panel panel-flat ">
		...
		<h1 class="panel-title bg-teal">Employee Remaining Leaves</h1>
		<br />
					   ...
					   foreach($allRequests as $request){
					   	...
					   	if($this->session->userdata('designationId') == '1' ){
                            ...
                            if($request['LTYPE_TYPE'] == 'Annual' ){
                              ...
                              if($request['LS_STATUS'] == 'Applied' && $request['DEPT_NAME'] == $this->session->userdata('department') || $request['LS_STATUS'] == 'Applied' &&  $request['DESG_ID'] == '42'){
                                ?>
							  ...
							  else if($request['LS_STATUS'] == 'Approved' || $request['LS_STATUS'] == 'Done' ){
                                    ?>
									<tr style="white-space : nowrap;">
											<td> <?php echo $request['EMP_BADGE_ID']?> </td>
											<td> <?php echo $request['EMP_NAME']?> </td>
							 ...
							 else if($request['LS_STATUS'] == 'Declined' && $request['DEPT_NAME'] == $this->session->userdata('department')) {
                                   ?>
								   <tr style="white-space : nowrap;">
											<td> <?php echo $request['EMP_BADGE_ID']?> </td>
											<td> <?php echo $request['EMP_NAME']?> </td>
                              ...
                              if($request['LS_STATUS'] == 'Applied' && $request['DEPT_NAME'] == $this->session->userdata('department')){
                                ?>
								<tr style="white-space : nowrap;">
											<td> <?php echo $request['EMP_BADGE_ID']?> </td>
											<td> <?php echo $request['EMP_NAME']?> </td>
						   ...
						   if($this->session->userdata('designationId') == '42' ){
									...
									if($request['LTYPE_TYPE'] == 'Annual' &&  $request['ROLE_NAME'] == 'Manager'){
							...
							else if($request['LTYPE_TYPE'] == 'Sick' &&  $request['ROLE_NAME'] == 'Manager'){
							...
							else if($request['LTYPE_TYPE'] == 'Unpaid'  &&  $request['ROLE_NAME'] == 'Manager' ){
                             ...
                             if($request['LTYPE_TYPE'] == 'Annual' &&  $request['DEPT_ID'] == $this->session->userdata('departmentId')){
						   ...
						   else if($request['LTYPE_TYPE'] == 'Sick' &&  $request['DEPT_ID'] == $this->session->userdata('departmentId')){
							...
							<?php
                              ...
                              if($request['LS_STATUS'] == 'Applied' &&  $request['DEPT_ID'] == $this->session->userdata('departmentId')){
                                ?>
								<tr style="white-space : nowrap;">
											<td> <?php echo $request['EMP_BADGE_ID']?> </td>
											<td> <?php echo $request['EMP_NAME']?> </td>
							  ...
							  else if($request['LS_STATUS'] == 'Approved' &&  $request['DEPT_ID'] == $this->session->userdata('departmentId')){
                                    ?>
									<tr style="white-space : nowrap;">
											<td> <?php echo $request['EMP_BADGE_ID']?> </td>
											<td> <?php echo $request['EMP_NAME']?> </td>
							   ...
							   else if($request['LS_STATUS'] == 'Done' &&  $request['DEPT_ID'] == $this->session->userdata('departmentId')){
                                    ?>
									<tr style="white-space : nowrap;">
											<td> <?php echo $request['EMP_BADGE_ID']?> </td>
											<td> <?php echo $request['EMP_NAME']?> </td>
							  ...
							  else if($request['LS_STATUS'] == 'Declined' &&  $request['DEPT_ID'] == $this->session->userdata('departmentId')) {
                                   ?>
								   <tr style="white-space : nowrap;">
											<td> <?php echo $request['EMP_BADGE_ID']?> </td>
											<td> <?php echo $request['EMP_NAME']?> </td>
