...
function editRequest(id,requestEmpId){  
	...
	if(requestEmpId != sesstionId && designationId != 1){
		jQuery(function(){
...
<div class="content">
	...
	<div class="panel panel-flat ">
		...
		<h1 class="panel-title bg-teal">Employee Requests</h1>
		<br />
		<div class="text-right form-inline">
		<?php if($this->session->userdata('designationId') == 1){ ?>
				<form  class="form-group" action="<?php echo base_url('admin/exportRequests') ?>"  method="post" id="exportUsers"  enctype="multipart/form-data">
					   ...
					   foreach($allRequests as $request){
					   	...
					   	if($this->session->userdata('designationId') == '1' ){
                            ...
                            if($request['LTYPE_TYPE'] == 'Annual' ){
                              ...
                              if($request['LS_STATUS'] == 'Applied' && $request['DEPT_NAME'] == $this->session->userdata('department') && $request['EMP_ID'] != $this->session->userdata('id') || $request['LS_STATUS'] == 'Applied' &&  $request['DESG_ID'] == '42' && $request['EMP_ID'] != $this->session->userdata('id') ){
                                ?>
							    	<tr style="white-space : nowrap;">
										...
										<td ><span><!--<input type="hidden" id="editRequstId" />--><i class="icon-pencil" data-toggle="modal" data-target="#modal_theme_bg_custom_EditRequest" onclick="editRequest('<?php echo $request['LREQ_ID'];?>','<?php echo $request['LREQ_EMP_ID'];?>','<?php echo $request['LREQ_STATUS_ID'];?>')"></i>&nbsp;</span>&nbsp;<span>&nbsp;<i class="icon-eye2" data-toggle="modal" data-target="#modal_theme_bg_custom_ViewRequest" onclick='viewRequest(<?php echo $request['LREQ_ID'];?>)'></i></span></td>
									</tr>
									<?php
							  }
                              ...
                              if($request['LS_STATUS'] == 'Applied' && $request['DEPT_NAME'] == $this->session->userdata('department') && $request['EMP_ID'] != $this->session->userdata('id') ){
                                ?>
								<tr style="white-space : nowrap;">
											<td> <?php echo $request['EMP_BADGE_ID']?> </td>
											<td> <?php echo $request['EMP_NAME']?> </td>
						   ...
						   if($this->session->userdata('designationId') == '42' ){

									if($request['LTYPE_TYPE'] == 'Annual' &&  $request['ROLE_NAME'] == 'Manager' && $request['EMP_ID'] != $this->session->userdata('id')  || 
										$request['LTYPE_TYPE'] == 'Annual' &&  $request['ROLE_NAME'] == 'Departmental' && $request['EMP_ID'] != $this->session->userdata('id') ){
											...
											else if($request['LS_STATUS'] == 'Approved' ){
													?>
													<tr style="white-space : nowrap;">
															<td> <?php echo $request['EMP_BADGE_ID']?> </td>
															<td> <?php echo $request['EMP_NAME']?> </td>
											...
											else if($request['LS_STATUS'] == 'Done' ){
													?>
													<tr style="white-space : nowrap;">
															<td> <?php echo $request['EMP_BADGE_ID']?> </td>
															<td> <?php echo $request['EMP_NAME']?> </td>
											...
											else if($request['LS_STATUS'] == 'Declined' ) {
												?>
												<tr style="white-space : nowrap;">
															<td> <?php echo $request['EMP_BADGE_ID']?> </td>
															<td> <?php echo $request['EMP_NAME']?> </td>
							...
							else if($request['LTYPE_TYPE'] == 'Sick' &&  $request['ROLE_NAME'] == 'Manager' && $request['EMP_ID'] != $this->session->userdata('id') || 
										$request['LTYPE_TYPE'] == 'Sick' &&  $request['ROLE_NAME'] == 'Departmental' && $request['EMP_ID'] != $this->session->userdata('id') ){
							...
							else if($request['LTYPE_TYPE'] == 'Unpaid'  &&  $request['ROLE_NAME'] == 'Manager' && $request['EMP_ID'] != $this->session->userdata('id') || 
										$request['LTYPE_TYPE'] == 'Unpaid' &&  $request['ROLE_NAME'] == 'Departmental' && $request['EMP_ID'] != $this->session->userdata('id') ){
                              ...
                              if($request['LS_STATUS'] == 'Applied'){
								...
								<tr style="white-space : nowrap;">
											...
											<td><span class="label label-primary"><?php echo $request['LTYPE_TYPE']?></span></td>
											<td><span class="label label-primary"><?php echo $request['LS_STATUS']?></span></td>
											<td ><?php if($request['EMP_ID'] != $this->session->userdata('id')){ ?>
                                            	<span><!--<input type="hidden" id="editRequstId" />--><i class="icon-pencil" data-toggle="modal" data-target="#modal_theme_bg_custom_EditRequest" onclick="editRequest('<?php echo $request['LREQ_ID'];?>','<?php echo $request['LREQ_EMP_ID'];?>')"></i>&nbsp;</span>&nbsp;
                                            <?php };?>
                                            <span>&nbsp;<i class="icon-eye2" data-toggle="modal" data-target="#modal_theme_bg_custom_ViewRequest" onclick='viewRequest(<?php echo $request['LREQ_ID'];?>)'></i></span></td>
									</tr>
							...
							<?php
                              ...
                              if($request['LS_STATUS'] == 'Applied' &&  $request['DEPT_ID'] == $this->session->userdata('departmentId') && $request['EMP_ID'] != $this->session->userdata('id') ){
						   	...
						   	else if($this->session->userdata('designationId') != '1'  && $this->session->userdata('designationId') != '42'  && $this->session->userdata('roleId') == '3' ) {
							  ...
							  else if($request['LS_STATUS'] == 'Approved'  &&  $request['EMP_ID'] == $this->session->userdata('id') ){
                                    ?>
									<tr style="white-space : nowrap;">
											<td> <?php echo $request['EMP_BADGE_ID']?> </td>
											<td> <?php echo $request['EMP_NAME']?> </td>
							  ...
							  else if($request['LS_STATUS'] == 'Done'   &&  $request['EMP_ID'] == $this->session->userdata('id')){
                                    ?>
									<tr style="white-space : nowrap;">
											<td> <?php echo $request['EMP_BADGE_ID']?> </td>
											<td> <?php echo $request['EMP_NAME']?> </td>
