	...
	<div class="navbar navbar-inverse bg-teal">
		...
		<div class="navbar-collapse collapse" id="navbar-mobile">
			...
			<ul class="nav navbar-nav">
					<li class="<?php if ($this->uri->segment(2) == "dashboard"){ echo "active";}?>"><a href="<?php echo base_url('user/dashboard');?>"><i class="icon-home4 text-teal-400"></i> <span>Dashboard</span></a></li>			
			</ul>
			<ul class="nav navbar-nav">
				<li class="<?php if ($this->uri->segment(2) == "requests"){ echo "active";}?>"><a href="<?php echo base_url('user/requests');?>"><i class="icon-list text-teal-400"></i> <span>Requests</span></a></li>	
			</ul>
				...
				<ul class="nav navbar-nav navbar-right">
				 <!--<li class="dropdown">
					...
					<ul class="dropdown-menu dropdown-menu-right">
						<!--<li><a href="<?php echo base_url('user/dashboard'); ?>"><i class="icon-user-plus"></i> My profile</a></li>-->
