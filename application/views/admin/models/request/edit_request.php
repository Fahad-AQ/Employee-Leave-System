					      ...
					      <div class="form-group">
							<div class="row">
								<div class="col-lg-6">
									...
									<input type="hidden" id="aer_rAnnuals" name="rAnnuals" value="1" placeholder="Enter Employee ID"  class="form-control" disabled>
									<input type="hidden" id="aer_rSicks" name="rSicks" value="1" placeholder="Enter Employee ID"  class="form-control" disabled>
									<input type="hidden" id="aer_leaveType" name="lt" value="1" placeholder="Enter Employee ID"  class="form-control" disabled>
									<input type="hidden" id="aer_doj" ><input type="hidden" id="aer_empId">
									<input type="hidden" id="aer_r_id" name="r_id"  placeholder="Enter Employee ID"  class="form-control" disabled>
									<input type="number" id="aer_empBatchId" name="batchId"  placeholder="Enter Employee ID"  class="form-control" disabled>
								</div>
								<div class="col-lg-6">
									<label class="col-lg-6 text-bold">Name:</label>
									<input type="text" id="aer_empName" name="name"  placeholder="Enter Name"  class="form-control" disabled>
								</div>
						    </div>
							<div class="row">
								<div class="col-lg-6">
										...
										<label class="control-label text-bold col-lg-6">Department:</label>
											<div class="col-lg-14">
													<select name="department" class="form-control required_editRequest"  id="aer_department" disabled>
								...
								<div class="col-lg-6">
									...
									<label class="control-label text-bold col-lg-6">Designation:</label>
										<div class="col-lg-14">
													<select name="designation" class="form-control required_editRequest"  id="aer_designation" disabled>
									...
									<div class="col-lg-6">
										<div class="form-group">
											<label class="control-label text-bold col-lg-6">Leave Total:</label>
												<div class="col-lg-14">
												<input type="text" name="leaveTotal" class="form-control"  id="aer_LeaveTotal" disabled>
												</div>
										</div>
									</div>
									<div class="col-lg-6">
										...
										<div class="col-lg-14">
											<input type="text" name="LeaveRemaining" class="form-control"  id="aer_LeaveRemaining" disabled>
										</div>
										</div>
									</div>
								</div>
								...
								<div class="col-lg-6">
									<div class="form-group">
										<label class="control-label text-bold col-lg-6">Start Date:</label>
											<div class="col-lg-14">
											<input type="date" id="aer_startDate" name="startDate" pattern="(0[1-9]|1[012])[/](0[1-9]|[12][0-9]|3[01])[/](19|20)\d\d" title="Correct dates allowed ex: 09/22/1993"  placeholder="Enter Start Date"  class="form-control required_editRequest" readonly="true">
											</div>
									</div>
								 </div>
								<div class="col-lg-6">
									...
									<div class="col-lg-14">
										<input type="date" id="aer_endDate" name="endDate" pattern="(0[1-9]|1[012])[/](0[1-9]|[12][0-9]|3[01])[/](19|20)\d\d" title="Correct dates allowed ex: 09/22/2015"  placeholder="Enter End Date"  class="form-control required_editRequest" readonly="true">
									</div>
									</div>
								</div>
						    </div>
								...
								<div class="col-md-6 leaveStyle form-horizontal">
									<p class="text-bold">Leave Type:</p>
								    			...
								    			<label class="btn btn-primary" style="width :300px" >
													<input type="radio" id="aer_annualType" value="1" checked="checked" class="aer_LType" name="leaveType" >&nbsp;Annual Leave
												</label>
												 <br />
												<label class="btn bg-success" style="width :300px">
													<input type="radio" id="aer_sickType"   value="2" class="aer_LType" name="leaveType" >&nbsp;Sick Leave&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												</label>
												 <br />
												<label class="btn btn-info" style="width :300px">
													<input type="radio" id="aer_unpaidType" value="3"  class="aer_LType" name="leaveType" >&nbsp;Unpaid Leave
												</label>
								...
								<div class="col-lg-6">
									...
									<div class="form-group">
										<label class="control-label text-bold col-lg-6">Total Days</label>
											<div class="col-lg-14">
												<input id="aer_totalDays"  name="totalDays"  placeholder="Automatically Count days"  class="form-control" disabled>
											</div>
										</div>
						     ...
						     <div class="col-lg-12">
									<div class="form-group">
										<label class="control-label text-bold col-lg-6">Requestor Comment</label>
											<div class="col-lg-14">
												<textarea rows="3" cols="3" class="form-control required_editRequest" placeholder="Enter Reason" id="aer_rComment"  name="rComment" ></textarea>
											</div>
										</div>
								</div>
						  </div>
							<div class="row" id="commentApprover">
								<div class="col-lg-12">
									<div class="form-group">
										<label class="control-label text-bold col-lg-6">Approver Comment</label>
											<div class="col-lg-14">
												<textarea rows="3" cols="3" class="form-control required_editRequest" placeholder="Enter Reason" id="aer_approverComment"  name="approverComment" ></textarea>
											</div>
										</div>
								</div>
							</div>
						   <div class="row" id="actionApprover" >
							   
						     <div class="col-lg-12">
								 <div class="form-group">
									<label class="control-label text-bold col-lg-6">HR Action:</label>
										<div class="col-lg-14">
													<select name="approverAction" class="form-control required_editRequest"  id="aer_approverAction">
														<?php 
														 foreach ($allLeaveStatus as $leave){
														 	if($leave['LS_ID'] == 2 || $leave['LS_ID'] == 4){
																	?>
...
<script>
 ...
 $(document).ready(function () { 
	...
	var joiningYear = new Date( parseDate(incr_date( $("#aer_doj" ).val()))).getFullYear();
	var joiningMonth = new Date( parseDate(incr_date( $("#aer_doj" ).val()))).getMonth()+1;
	var joiningDate = new Date( parseDate(incr_date( $("#aer_doj" ).val()))).getDate();
...
yesterday ;
    var from_$input = $('#aer_startDate').pickadate({
    	min : $('#aer_startDate').val(),
		format: 'mm/dd/yyyy', 
    ...
    from_picker.set('select',$('#aer_startDate').val())

	var to_$input = $('#aer_endDate').pickadate({
	format: 'mm/dd/yyyy', 
	editable : false , today: '',
	clear: '',
	close: ''
...
from_picker.on('set', function(event) {
  if ( event.select ) {
    to_picker.set('min', from_picker.get('select'));
    to_picker.set('select', $('#aer_endDate').val());
	    if(($('#aer_startDate').val() == "") && ($('#aer_endDate').val() == "" )){
		 $('#aer_totalDays').val("Select Start Date and End Date");
		}
		else if (($('#aer_startDate').val() == "") && ($('#aer_endDate').val() != "" )){
            $('#aer_totalDays').val("Select Start Date");
		}
		else if (($('#aer_startDate').val() != "") && ($('#aer_endDate').val() == "" )){
            $('#aer_totalDays').val("Select End Date");
		}
		}
		else if (($('#aer_startDate').val() == $('#aer_endDate').val()) && (($('#aer_startDate').val() != "") && ($('#aer_endDate').val() != "" ))){
            $('#aer_totalDays').val("1");
		}

		else{

		 $('#aer_totalDays').val(1+daydiff(parseDate($('#aer_startDate').val()), parseDate($('#aer_endDate').val()))+"");
		}
  }
...
$('#aer_annualType').click(function (){
   ...
   jQuery(function(){
		...
		RadionButtonSelectedValueSet('aer_LType', 1);
	})
});

$('#aer_sickType').click(function (){
   $( "#aer_leaveType" ).val('2');
   jQuery(function(){
		function RadionButtonSelectedValueSet(cls, SelectdValue) {
			$('.'+cls).each(function() {
		...
		RadionButtonSelectedValueSet('aer_LType', 2);
	})
});

$('#aer_unpaidType').click(function (){
   $( "#aer_leaveType" ).val('3');
   jQuery(function(){
		function RadionButtonSelectedValueSet(cls, SelectdValue) {
			$('.'+cls).each(function() {
		...
		RadionButtonSelectedValueSet('aer_LType', 3);
	})
});
...
$('#editUserRequestForm').on('submit', function(e){
    ...
    var currentStatusMonth = monthDiff(joiningYear,currentYear,joiningMonth,currentMonth,joiningDate,currentDate);
				...
				if( $( "#aer_startDate" ).val() && $( "#aer_endDate" ).val() &&  $( "#aer_totalDays" ).val() && $( "#aer_rComment" ).val() ){
				
						if($( "#aer_leaveType" ).val() == '1'){
                                ...
                                if(currentStatusMonth < 12){
								   ...
								   $.ajax({
										...
										success: function (data){
											...
											var approvedDays = (parseInt($( "#aer_rAnnuals" ).val()) > 0)  ? parseInt($( "#aer_rAnnuals" ).val()) : 0;
											if(data){
											...
											if(currentStatusMonth >= 12 && (parseInt(totalAnnuals) + 1  - (parseInt(approvedDays) + parseInt($( "#aer_totalDays" ).val())) ) > 0 || $("#aer_approverAction").val() == 1 && $("#aer_empId").val() != "$this->session->userdata('id')" || $("#aer_approverAction").val() == 2 || $("#aer_approverAction").val() == 3 || $("#aer_approverAction").val() == 4){
                                                
												var startDate = $("#aer_startDate").val(); 
												var DateNewFormat = $.datepicker.formatDate( "yy-mm-dd", new Date( startDate ) );

												var endDate = $("#aer_endDate").val(); 
												var DateNewFormat2 = $.datepicker.formatDate( "yy-mm-dd", new Date( endDate ) );
												
												$.ajax({
													type: 'POST',
													data: {'r_id': $("#aer_r_id").val(),'employeeId' : $("#aer_empId").val(),'employeeLType' :$( "#aer_leaveType" ).val()
													,'startDate' : DateNewFormat,'endDate' : DateNewFormat2,'r_Comment' : $("#aer_rComment").val() ,'leaveStatus' : $("#aer_approverAction").val() , 'approver_Comment' : $("#aer_approverComment").val() },
													url: '<?php echo base_url('admin/editRequest');?>',	
													dataType: 'json',
													success: function (data){
														if(data.status == 'exist' ){
															...
															setTimeout(function(){
																window.location.href = '<?php base_url('admin/requests')?>'; 
															}, 1200)
									...
									if(currentStatusMonth < 3){
									 ...
									 if(currentStatusMonth >= 2){
										...
										success: function (data){
											...
											var approvedDays = (parseInt($( "#aer_rSicks" ).val()) > 0)  ? parseInt($( "#aer_rSicks" ).val()) : 0;
											if(data){
                                              for(var i=0 ; i<data.length ; i++){
											   approvedDays+= parseInt(1+daydiff(parseDate(incr_date(data[i].LREQ_START)),parseDate(incr_date(data[i].LREQ_END))));
											 }
											}
											if(currentStatusMonth >= 3 && (parseInt(totalSicks) + 1 - (parseInt(approvedDays) + parseInt($( "#aer_totalDays" ).val()) ) ) > 0 || $("#aer_approverAction").val() == 1 && $("#aer_empId").val() != "$this->session->userdata('id')" || $("#aer_approverAction").val() == 2 || $("#aer_approverAction").val() == 3|| $("#aer_approverAction").val() == 4){
                                               	var startDate = $("#aer_startDate").val(); 
												var DateNewFormat = $.datepicker.formatDate( "yy-mm-dd", new Date( startDate ) );
									...
									if(currentStatusMonth < 3 ){
										...
										var diffDays = parseInt(getDaysInMonth(joiningMonth+1, 2012)+getDaysInMonth(joiningMonth+2, 2012)+getDaysInMonth(joiningMonth+3, 2012)) - Math.round(Math.abs(((firstDate.getTime() - secondDate.getTime())/oneDay)));	
											...
											$('.message').slideDown(2500).html("Your "+ elegibleMonth + " month is remaining eligible for Unpaid Leave");
												...
												if(currentStatusMonth >= 3 && (parseInt(totalUnpaid) + 1  - (parseInt(approvedDays) + parseInt($( "#aer_totalDays" ).val())) ) > 0 || $("#aer_approverAction").val() == 1 && $("#aer_empId").val() != "$this->session->userdata('id')" || $("#aer_approverAction").val() == 2 || $("#aer_approverAction").val() == 3|| $("#aer_approverAction").val() == 4){
