						...
						<div class="panel bg-green-400">
							<div class="panel-body">
								<div class="heading-elements">
									<i class="icon-pencil7" style="font-size: xx-large;"></i>
								</div>
...
$.ajax({
	...
	success: function (data){
		...
		annualRemaining.innerHTML = (totalAnnuals) ? totalAnnuals - approvedDays : 0 ;
		},
		...
		success: function (data){
              Highcharts.chart('chart1', {
					...
					title: {
						...
						subtitle: {
							text: 'Your Monthly Wise Leave Chart'
						},
						plotOptions: {
							column: {
								depth: 25
...
$(function () {
    ...
    var brightness;
            ...
            $('#chart2').highcharts({
                ...
                subtitle: {
                    text: 'All Managers Approved Leaves Chart'
                },
                yAxis: {
                    title: {
