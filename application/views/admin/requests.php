				 ...
				 if($allRequests == false ){
                    echo null;
					   ...
					   foreach($allRequests as $request){
						   if($request['LTYPE_TYPE'] == 'Annual' && $request['EMP_ID'] != $this->session->userdata('id') ){
                               if($request['LS_STATUS'] == 'Approved' || $request['LS_STATUS'] == 'Done' ){
                                    ?>
						   ...
						   else if($request['LTYPE_TYPE'] == 'Sick' && $request['EMP_ID'] != $this->session->userdata('id')){
							...
							<?php
                                 ...
                                 if($request['LS_STATUS'] == 'Approved' && $request['EMP_ID'] != $this->session->userdata('id') || $request['LS_STATUS'] == 'Done' && $request['EMP_ID'] != $this->session->userdata('id')){
                                    ?>
									<tr style="white-space : nowrap;">
											<td> <?php echo $request['EMP_BADGE_ID']?> </td>
											<td> <?php echo $request['EMP_NAME']?> </td>
