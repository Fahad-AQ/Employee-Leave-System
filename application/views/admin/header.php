	...
	<div class="navbar navbar-inverse bg-teal">
		...
		<div class="navbar-collapse collapse" id="navbar-mobile">
			...
			<ul class="nav navbar-nav">
				...
				<ul class="nav navbar-nav">
					<li class="<?php if ($this->uri->segment(2) == "users"){ echo "active";}?>"><a href="<?php echo base_url('admin/users');?>"><i class="icon-list text-teal-400"></i> <span>Users</span></a></li>			
			</ul>
			<!-- <ul class="nav navbar-nav">
				<li class="<?php if ($this->uri->segment(2) == "remainingLeaves"){ echo "active";}?>"><a href="<?php echo base_url('admin/remainingLeaves');?>"><i class="icon-list text-teal-400"></i> <span>Employees Remainings Leaves</span></a></li>	
			</ul> -->
			<ul class="nav navbar-nav">
				<li class="<?php if ($this->uri->segment(2) == "requests"){ echo "active";}?>"><a href="<?php echo base_url('admin/requests');?>"><i class="icon-list text-teal-400"></i> <span>Employees Requests</span></a></li>	
			</ul>
			<ul class="nav navbar-nav">
				<li class="<?php if ($this->uri->segment(2) == "selfRequests"){ echo "active";}?>"><a href="<?php echo base_url('admin/selfRequests');?>"><i class="icon-list text-teal-400"></i> <span>Self Requests</span></a></li>	
			</ul>
				...
				<ul class="nav navbar-nav navbar-right">
				 <!--<li class="dropdown">
					...
					<ul class="dropdown-menu dropdown-menu-right">
						<!--<li><a href="<?php echo base_url('admin/dashboard'); ?>"><i class="icon-user-plus"></i> My profile</a></li>-->
